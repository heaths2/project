    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gender', models.SmallIntegerField(choices=[(None, '성별 선택'), (0, '선택하지 않음'), (1, '남성'), (2, '여성')], default=None, verbose_name='gender')),
                ('department', models.SmallIntegerField(choices=[(None, '부서 선택'), (0, '경영지원'), (1, '영업'), (2, '1팀'), (3, '2팀')], default=None, verbose_name='department')),
