    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gender', models.SmallIntegerField(choices=[(None, '성별 선택'), (0, '선택하지 않음'), (1, '남성'), (2, '여성')], default=None)),
                ('department', models.SmallIntegerField(choices=[(None, '부서 선택'), (0, '영업'), (1, '1팀'), (2, '2팀')], default=None, verbose_name='department')),
