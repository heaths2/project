    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('mobile_phone', models.CharField(db_column='mobile_phone', max_length=13, unique=True, validators=[django.core.validators.RegexValidator(message='휴대전화 번호를 입력하시오.', regex='^[0-9]{2,3}-[0-9]{3,4}-[0-9]{4}$')], verbose_name='연락처')),
