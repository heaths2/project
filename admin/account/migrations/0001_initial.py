# Generated by Django 2.1.15 on 2020-03-21 10:15
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('username', models.CharField(db_column='username', max_length=6, unique=True, validators=[django.core.validators.RegexValidator(message='이름을 입력하시오.', regex='^[가-힣]+$')], verbose_name='이름')),
                ...
                ('date_of_birth', models.DateTimeField(auto_now_add=True, db_column='date_of_birth', verbose_name='생년월일')),
                ('gender', models.SmallIntegerField(choices=[(0, 'Not to selected'), (1, 'Male'), (2, 'Female')])),
